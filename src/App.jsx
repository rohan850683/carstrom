...
<div className="section-container">
  <h1 className="section-title">Toyota</h1>
  <div className="car-section">
    <Cart Image="https://stimg.cardekho.com/images/carexteriorimages/930x620/Toyota/Fortuner-Legender/10229/1749726924621/front-left-side-47.jpg" Card="Fortuner" Some="The Mahindra XUV700 is a popular SUV..." Go="Buy Now" url="http://localhost:5173/xuv700" />
    <Cart Image="https://www.tyremarket.com/tyremantra/wp-content/uploads/2020/04/toyota-glanza.jpg" Card="Glanza" Some="The Mahindra Thar is a rugged and powerful SUV..." Go="Buy Now" url="http://localhost:5173/thar" />
    <Cart Image="https://imagecdnsa.zigwheels.ae/large/gallery/exterior/40/1867/toyota-innova-hycross-front-angle-low-view-446020.jpg" Card="Innova" Some="The Mahindra Scorpio Classic is a rugged and powerful SUV..." Go="Buy Now" url="http://localhost:5173/scorpio" />
    <Cart Image="https://res.cloudinary.com/jerrick/image/upload/d_642250b563292b35f27461a7.png,f_jpg,fl_progressive,q_auto,w_1024/64725b6d365a8f001d7f50a1.jpg" Card="Supra" Some="The Mahindra Bolero is a popular utility vehicle in India..." Go="Buy Now" url="http://localhost:5173/bolero" />
    <Cart Image="https://media.ed.edmunds-media.com/toyota/corolla-cross/2025/oem/2025_toyota_corolla-cross_4dr-suv_l_fq_oem_1_1280.jpg" Card="Corolla-Cross" Some="The Mahindra BE 6 is an upcoming electric SUV..." Go="Buy Now" url="http://localhost:5173/be-6" />
    <Cart Image="https://stimg.cardekho.com/images/carexteriorimages/930x620/Toyota/Hilux/10924/1691990326111/front-left-side-47.jpg" Card="Hilux" Some="The Mahindra Alturas G4 is a large, 7-seater SUV..." Go="Buy Now" url="http://localhost:5173/alturas" />
  </div>
</div>
...
<div className="brand-section">
  ...
  <div className="car-grid">
    ...
    <Cart Image="https://www.bowkermotorgroup.co.uk/wp-content/uploads/2025/04/P90585145_highRes_the-new-bmw-ix-xdriv-scaled.jpg" Card="IX" Some="The BMW iX is a fully electric luxury SUV..." Go="Buy Now" url="http://localhost:5173/IX" />
  ...
  <div className="car-section">
    <Cart Image="https://media.assettype.com/evoindia/2021-08/1c32d636-7de7-4af3-a631-3a89fa2bbba1/xuv700hero.jpeg" Card="XUV700" Some="The Mahindra XUV700 is a popular SUV..." Go="Buy Now" url="http://localhost:5173/xuv700" />
